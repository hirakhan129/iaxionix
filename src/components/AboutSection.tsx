...
const AboutSection = () => {
  return (
    <section id="about" className="section-spacing bg-techDarkGreen/20">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
            Who <span className="text-techGreen">We Are</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="glass-morphism p-6 rounded-[15px]">
              <h3 className="text-techGreen text-xl font-semibold mb-2">Our Mission</h3>
            ...
            <div className="glass-morphism p-6 rounded-[15px]">
              <h3 className="text-techGreen text-xl font-semibold mb-2">Our Vision</h3>
              <p className="text-techGray">To be the leading agency in creating sustainable and intelligent digital ecosystems.</p>
            </div>
            
            <div className="glass-morphism p-6 rounded-[15px]">
              <h3 className="text-techGreen text-xl font-semibold mb-2">Our Values</h3>
